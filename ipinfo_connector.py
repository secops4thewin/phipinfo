...
class IpInfoConnector(BaseConnector):
    ...
    def _handle_geolocate_ip(self, param):
        ...
        # Extract Latitude from json output
        response['latitude'] = response['loc'].split(',')[0]

        # Extract Longitude from json output
        response['longitude'] = response['loc'].split(',')[1]
    ...
    def _handle_lookup_ip(self, param):
        ...
        # Extract Longitude from json output
        response['longitude'] = response['loc'].split(',')[0]
